from crawler import run_f1_news_crawler
from cleaning import merge_and_clean_data
from translate_openai import fetch_and_translate_column
import datetime
import json
import logging
import sys
...
logging.basicConfig(
    filename="logs/translate_errors.log",
    filemode="a",
...
if __name__ == "__main__":
    try:
        ...
        crawler_dir = "debug/raw"
        clean_dir = "debug/cleaned_data"
        translated_crawler_dir = "debug/translated_data"

        # Number of days to fetch news from
        fetch_days = 1

        # Debug flags for different steps
        step1_debug = True  # For Fetch News
        step2_debug = True  # For Merge and Clean Data
        ...
        cleaned_data = merge_and_clean_data(all_news_data, clean_dir, debug=step2_debug)
        ...
        try:
            translated = fetch_and_translate_column(
                cleaned_data, translated_crawler_dir
            )
            if translated:
